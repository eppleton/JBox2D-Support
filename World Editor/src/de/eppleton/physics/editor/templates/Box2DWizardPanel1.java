...
public class Box2DWizardPanel1 implements WizardDescriptor.Panel<WizardDescriptor> {

    /**
     * The visual component that displays this panel. If you need to access the
     * component from this class, just use getComponent().
     */
    private Box2DVisualPanel1 component;
    ...
    @Override
    public Box2DVisualPanel1 getComponent() {
        if (component == null) {
            component = new Box2DVisualPanel1();
        }
        return component;
    }
